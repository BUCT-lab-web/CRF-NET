...
add_data = "unsize_Disjoint_0PaviaU/"  ##########
...
#    # print ('typ/"+"probability/"+i_test+"p/"+"probability/"+i_test+"probability_softmax.txt", probability_softmax, '%.3f')
...
#     #print ('lab/"+"probability/"+i_test+"labels_pred.txt", labels_pred, '%d')
